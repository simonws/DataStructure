package shopping_demo.com.datastructure.stack;
...
public class MinStack {
    ...
    /**
     * 添加数据，首先是往stack栈中添加 如果最小栈minStack为空，或者栈顶的元素比新添加的元素要大，则将新元素也要添加的辅助栈中
     * 
     * @param node
     */
    ...
    /**
     * 如果stack空，直接返回 如果stack不为空，得到栈顶元素，同时将栈顶元素弹出 如果最小栈的栈顶元素与stack弹出的元素相等，那么最小栈也要将其弹出
     */
    public void pop() {
        if (stack.isEmpty())
            return;
